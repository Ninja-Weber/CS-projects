...
with st.expander("PROJECT DETAILS"):
    ...
    st.write('https://github.com/DrumilNikhare/threat_detection')
...
with st.expander('EXAMPLE PHISHING URLs:'):
    st.write('https://support-advertising-appeal.d3nt1blj7sqhjb.amplifyapp.com/')
    st.write('https://bantuan-dana-indonesia.officio.asia/')
    st.write('https://user.fm/files/v2-bbcb0fd2764e52cba45f968d9486c146/Abs.HTML')
